 ...
 * @author shadman
 */
public class FoodView extends javax.swing.JPanel {

    /**
     * Creates new form BookView
     */
    ArrayList<Food> books;
    int rows = 0;
    static final Rectangle pnl = new Rectangle(280, 420);

    public FoodView(ArrayList<Food> books) {
        initComponents();
        this.books = books;
        rows = Math.floorDiv(books.size(), 4);
        this.setLayout(new WrapLayout(WrapLayout.LEADING, 80, 80));
        var grid = this;
        this.setBackground(Colour.bgp);
        for (Food bk: books) {
